            ...
            <div className="formulario w-75">      
                    <div className="card border-0 shadow">
                        <div className="card-body">
                            ...
                            <form id="formulario">
                                <input type="text" name="" id="" className="form-control my-4 py-2 text-center" placeholder="Ingrese su Nombre" required></input>
                                <input type="text" name="" id="" className="form-control my-4 py-2 text-center" placeholder="Ingrese su Apellido" required></input>
                                <input type="email" name="" id="" className="form-control my-4 py-2 text-center" placeholder="Ingrese su Correo Electronico" required></input>
                                ...
                                <input type="text" name="" id="" className="form-control my-4 py-2 text-center" placeholder="Ingrese su Direccion" required></input>
